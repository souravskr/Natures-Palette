...
var AppComponent = /** @class */ (function () {
    function AppComponent() {
        this.title = 'Natures-Palette';
    }
    AppComponent.prototype.fileEvent = function (fileInput) {
        var AWSService = aws_sdk__WEBPACK_IMPORTED_MODULE_2__;
        var region = 'Global';
        var bucketName = 'naturespalette';
        var IdentityPoolId = 'npidentitypool';
        var file = fileInput.target.files[0]; // Configures the AWS service and initial authorization
...
module.exports = __webpack_require__(/*! D:\Projects\Natures-Palette\Natures-Palette\src\main.ts */"./src/main.ts");
